...
class AgentManager(Base):
    ...
    def register_agent(self, agent_path):
        ...
        self._call('RegisterAgent', agent_path, 'o', reply_handler=on_registered, error_handler=on_register_failed)
    ...
    def unregister_agent(self, agent_path):
        ...
        self._call('UnregisterAgent', agent_path, 'o', reply_handler=on_unregistered, error_handler=on_unregister_failed)
