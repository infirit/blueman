...
class SerialService(Service):
    ...
    def try_replace_root_watcher(self, monitor, path, port):
        ...
        Mechanism(interface_name='org.blueman.Mechanism.Rfcomm').close_rfcomm('(d)', port)
    ...
    def connect(self, reply_handler=None, error_handler=None):
        ...
        try:
            ...
            Mechanism(interface_name='org.blueman.Mechanism.Rfcomm').open_rfcomm('(d)', port_id)
    ...
    def disconnect(self, port_id, reply_handler=None, error_handler=None):
        try:
            Mechanism(interface_name='org.blueman.Mechanism.Rfcomm').close_rfcomm('(d)', port_id)
